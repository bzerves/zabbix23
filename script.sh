...
toilet -w 100 -f smmono9 Zerves Comunidade | lolcat
...
clear
toilet -w 82 -f mini Zerves Comunidade | lolcat
toilet -w 100 -f smmono9 Zerves Comunidade | lolcat
rm /tmp/finish
...
EOF
. ~/.bashrc 
alias fixmibs="MIBDIRS=/usr/share/snmp/mibs/iana/:/usr/share/snmp/mibs/ietf/:/usr/share/snmp/mibs/vendors/:`ls  -d /usr/share/snmp/mibs/*/*/ | xargs | tr ' ' ':'`"
